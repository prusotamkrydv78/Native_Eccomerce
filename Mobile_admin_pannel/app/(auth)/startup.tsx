      ...
      <View className="flex-1 items-center justify-end">
        ...
        >
          <View className=" p-4 rounded-t-3xl bg-transparent h-1/2 py-8 justify-center items-center">
            <Text className="text-5xl text-white font-bold text-center pb-2">
              You want Authentic, here you go!
            </Text>
            <Text className="text-xl text-center pb-4 text-white">
            ...
            >
              <Text className="text-white text-3xl text-center px-20 py-2 ">
                Get Started
              </Text>
            </TouchableOpacity>
          </View>
